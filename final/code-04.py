...
print('Shortest path from baby to man is :',nx.shortest_path(G,source='baby',target='man',weight='weight'))
print('Shortest path length from baby to man is :',nx.shortest_path_length(G,source='baby',target='man',weight='weight'))
